...
The ability to improve a system is proportional to how easily you can verify its output. [Ref] A Harness turns vague, multi-step agent workflows into structured data that we can log and grade, allowing us to hill-climb effectively.
